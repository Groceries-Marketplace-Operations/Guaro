...
const FIELD_TYPES = ['texto', 'text_box', 'numero', 'link', 'link_spreadsheet', 'select', 'select_brand', 'multiple_brands', 'select_store', 'select_ka_type', 'select_country', 'select_biz_category', 'file'];
